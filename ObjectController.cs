...
public class ObjectController : MonoBehaviour
{
    ...
    {
        SetMaterial(true);
        // make all collectibles move at the player
        GameObject[] collectibles = GameObject.FindGameObjectsWithTag("recolectable");
        foreach (GameObject collectible in collectibles)
        {
            collectible.SendMessage("StartMovingTowardsPlayer");
        }
    }
    ...
    {
        SetMaterial(false);
        // make all collectibles stop moving at the player
        GameObject[] collectibles = GameObject.FindGameObjectsWithTag("recolectable");
        foreach (GameObject collectible in collectibles)
        {
            collectible.SendMessage("StopMovingTowardsPlayer");
        }
    }
